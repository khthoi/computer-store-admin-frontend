...
<p>
  ...
  specificationGroups: [
    // ── Inherited from category: GPU ──────────────────────────────────────────
    {
      ...
      inherited: true,
      items: [
        { id: "spec-1", typeId: "t-arch",    typeLabel: "Architecture",       value: "Ada Lovelace" },
        { id: "spec-2", typeId: "t-cuda",    typeLabel: "CUDA Cores",         value: "16,384" },
        { id: "spec-3", typeId: "t-boost",   typeLabel: "Boost Clock (OC)",   value: "2610 MHz" },
        { id: "spec-4", typeId: "t-base",    typeLabel: "Base Clock",         value: "2235 MHz" },
        { id: "spec-5", typeId: "t-tdp",     typeLabel: "TDP",                value: "450 W" },
      ],
    },
    // ── Inherited from category: GPU ──────────────────────────────────────────
    {
      ...
      inherited: true,
      items: [
        { id: "spec-6",  typeId: "t-memsize", typeLabel: "Memory Size",   value: "24 GB" },
        { id: "spec-7",  typeId: "t-memtype", typeLabel: "Memory Type",   value: "GDDR6X" },
        { id: "spec-8",  typeId: "t-membus",  typeLabel: "Memory Bus",    value: "384-bit" },
        { id: "spec-9",  typeId: "t-membw",   typeLabel: "Bandwidth",     value: "1008 GB/s" },
      ],
    },
    // ── Directly assigned to this variant ─────────────────────────────────────
    {
      ...
      inherited: false,
      items: [
        { id: "spec-10", typeId: "t-length",    typeLabel: "Card Length",      value: "357 mm" },
        { id: "spec-11", typeId: "t-slots",     typeLabel: "Slot Width",       value: "3.5 slots" },
        { id: "spec-12", typeId: "t-outputs",   typeLabel: "Display Outputs",  value: "<ul><li>3× DisplayPort 1.4a</li><li>1× HDMI 2.1</li></ul>" },
        { id: "spec-13", typeId: "t-power",     typeLabel: "Power Connector",  value: "1× 16-pin (PCIe 5.0)" },
        { id: "spec-14", typeId: "t-weight",    typeLabel: "Card Weight",      value: "1.85 kg" },
      ],
    },
  ],
