...
const GPU_TEMPLATE: SpecificationGroup[] = [
  {
    ...
    inherited: true,
    items: [
      { id: "tpl-gpu-core-1", typeId: "t-arch",  typeLabel: "Architecture", description: "e.g. Ada Lovelace, RDNA 3",           maKyThuat: "gpu_architecture",    value: "" },
      { id: "tpl-gpu-core-2", typeId: "t-cuda",  typeLabel: "Shader Units", description: "CUDA cores / Stream Processors",       maKyThuat: "cuda_cores",          value: "" },
      { id: "tpl-gpu-core-3", typeId: "t-boost", typeLabel: "Boost Clock",  description: "MHz — OC mode",                        maKyThuat: "gpu_boost_clock_mhz", value: "" },
      { id: "tpl-gpu-core-4", typeId: "t-base",  typeLabel: "Base Clock",   description: "MHz",                                  maKyThuat: "gpu_base_clock_mhz",  value: "" },
      { id: "tpl-gpu-core-5", typeId: "t-tdp",   typeLabel: "TDP",          description: "Thermal Design Power in watts",        maKyThuat: "tdp_watt",            value: "" },
    ],
  },
  {
    id: "tpl-gpu-memory",
    ...
    inherited: true,
    items: [
      { id: "tpl-gpu-mem-1", typeId: "t-memsize", typeLabel: "Memory Size", description: "e.g. 8 GB, 16 GB, 24 GB",        maKyThuat: "vram_size_gb",        value: "" },
      { id: "tpl-gpu-mem-2", typeId: "t-memtype", typeLabel: "Memory Type", description: "e.g. GDDR6, GDDR6X, HBM3",       maKyThuat: "vram_type",           value: "" },
      { id: "tpl-gpu-mem-3", typeId: "t-membus",  typeLabel: "Memory Bus",  description: "e.g. 128-bit, 256-bit, 384-bit", maKyThuat: "vram_bus_width",      value: "" },
      { id: "tpl-gpu-mem-4", typeId: "t-membw",   typeLabel: "Bandwidth",   description: "GB/s",                           maKyThuat: "vram_bandwidth_gbps", value: "" },
    ],
  },
  {
    id: "tpl-gpu-physical",
    ...
    inherited: false,
    items: [
      { id: "tpl-gpu-phys-1", typeId: "t-length",  typeLabel: "Card Length",     description: "mm",                                   maKyThuat: "card_length_mm",  value: "" },
      { id: "tpl-gpu-phys-2", typeId: "t-slots",   typeLabel: "Slot Width",      description: "e.g. 2.5 slots, 3.5 slots",           maKyThuat: "card_slot_width", value: "" },
      ...
      { id: "tpl-gpu-phys-5", typeId: "t-cardwt",  typeLabel: "Card Weight",     description: "kg",                                   maKyThuat: "card_weight_kg",  value: "" },
    ],
  },
];
...
const CPU_TEMPLATE: SpecificationGroup[] = [
  {
    ...
    inherited: true,
    items: [
      { id: "tpl-cpu-proc-1", typeId: "t-cpu-arch",    typeLabel: "Architecture",        description: "e.g. Raptor Lake, Zen 4", maKyThuat: "cpu_architecture",    value: "" },
      { id: "tpl-cpu-proc-2", typeId: "t-cpu-cores",   typeLabel: "Total Cores",         description: "P-cores + E-cores",       maKyThuat: "cpu_core_count",      value: "" },
      { id: "tpl-cpu-proc-3", typeId: "t-cpu-threads", typeLabel: "Threads",             description: "",                        maKyThuat: "cpu_thread_count",    value: "" },
      { id: "tpl-cpu-proc-4", typeId: "t-cpu-base",    typeLabel: "Base Frequency",      description: "GHz (P-core)",            maKyThuat: "cpu_base_freq_ghz",   value: "" },
      { id: "tpl-cpu-proc-5", typeId: "t-cpu-boost",   typeLabel: "Max Turbo Frequency", description: "GHz (P-core)",            maKyThuat: "cpu_boost_freq_ghz",  value: "" },
      { id: "tpl-cpu-proc-6", typeId: "t-cpu-cache",   typeLabel: "L3 Cache",            description: "MB",                      maKyThuat: "cpu_l3_cache_mb",     value: "" },
      { id: "tpl-cpu-proc-7", typeId: "t-cpu-tdp",     typeLabel: "Base TDP",            description: "W",                       maKyThuat: "cpu_tdp_watt",        value: "" },
    ],
  },
  {
    id: "tpl-cpu-platform",
    ...
    inherited: true,
    items: [
      { id: "tpl-cpu-plat-1", typeId: "t-cpu-socket",  typeLabel: "CPU Socket",          description: "e.g. LGA1700, AM5",   maKyThuat: "cpu_socket",        value: "" },
      { id: "tpl-cpu-plat-2", typeId: "t-cpu-memtype", typeLabel: "Memory Type Support", description: "e.g. DDR5, DDR4",     maKyThuat: "cpu_mem_type",      value: "" },
      { id: "tpl-cpu-plat-3", typeId: "t-cpu-memch",   typeLabel: "Memory Channels",     description: "e.g. Dual-channel",   maKyThuat: "cpu_mem_channels",  value: "" },
      { id: "tpl-cpu-plat-4", typeId: "t-cpu-maxmem",  typeLabel: "Max Memory Speed",    description: "MHz (official spec)", maKyThuat: "cpu_max_mem_mhz",   value: "" },
    ],
  },
  {
    id: "tpl-cpu-box",
...
const SSD_TEMPLATE: SpecificationGroup[] = [
  {
    ...
    inherited: true,
    items: [
      { id: "tpl-ssd-perf-1", typeId: "t-ssd-iface", typeLabel: "Interface",        description: "e.g. PCIe 4.0 ×4, PCIe 5.0 ×4, SATA", maKyThuat: "ssd_interface",    value: "" },
      { id: "tpl-ssd-perf-2", typeId: "t-ssd-form",  typeLabel: "Form Factor",      description: "e.g. M.2 2280, 2.5\"",                   maKyThuat: "ssd_form_factor",  value: "" },
...
const RAM_TEMPLATE: SpecificationGroup[] = [
  {
    ...
    inherited: true,
    items: [
      { id: "tpl-ram-spec-1", typeId: "t-ram-type",  typeLabel: "Memory Type", description: "e.g. DDR5, DDR4",              maKyThuat: "ram_type",      value: "" },
      { id: "tpl-ram-spec-2", typeId: "t-ram-speed", typeLabel: "Speed",       description: "MHz (e.g. 6400, 7200)",        maKyThuat: "ram_speed_mhz", value: "" },
      { id: "tpl-ram-spec-3", typeId: "t-ram-cap",   typeLabel: "Capacity",    description: "Total GB (e.g. 16 GB, 32 GB)", maKyThuat: "ram_capacity_gb", value: "" },
...
const MOTHERBOARD_TEMPLATE: SpecificationGroup[] = [
  {
    ...
    items: [
      ...
      { id: "tpl-mb-board-3", typeId: "t-mb-socket",  typeLabel: "CPU Socket",  description: "e.g. LGA1700, AM5", maKyThuat: "mb_cpu_socket",  value: "" },
      { id: "tpl-mb-board-4", typeId: "t-mb-memtype", typeLabel: "Memory Type", description: "DDR5 / DDR4",       maKyThuat: "mb_mem_type",    value: "" },
