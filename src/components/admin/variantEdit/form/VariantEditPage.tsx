...
import { SpecificationEditor } from "../specs/SpecificationEditor";
import { MediaManager } from "../media/MediaManager";
import { VariantDescriptionSection } from "@/src/components/admin/variant/info/VariantDescriptionSection";
